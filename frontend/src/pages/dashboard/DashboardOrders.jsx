  ...
  import { getAllOrders } from "../../api/order"; // Import the getAllOrders function
  ...
  export const DashboardOrders = () => {
    ...
    const totalOriginalItems = tableData.length;
    ...
    const handlePageChange = (pageNumber) => {
      ...
      if (searchQuery) {
        ...
        dataForPage = tableData.slice(startIndex, endIndex);
      }
    ...
    return (
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <Pagination
          ...
          itemsPerPage={itemsPerPage}
          data={searchQuery ? filteredData : tableData}
        />
      </div>
    );
  };
